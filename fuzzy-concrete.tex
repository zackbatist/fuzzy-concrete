...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, toprule=.15mm, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, leftrule=.75mm, breakable, arc=.35mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-note-color-frame]
...
in Archaeological Practice}. Please refer to the version of record when
citing this work, using DOI:
...
establishing trust, which can be achieved through mutual understanding
of the challenges that had to be overcome to get observations to fit
within discrete data structures, and relying on mechanisms of control to
ensure that data are collected and maintained in a consistent manner.
...
are produced through improvised, semistructured, and discursive actions
feasible given practical concerns and limited by the prior experiences
held by those doing the work.
...
further demonstrate how the latter is leveraged by the former to produce
a clear and concise basis upon which formal analytical methods rest.
Moreover, Batist (2024) and Hacıgüzeller, Taylor, and Perry (2021) point
out that the formal and transactional paradigm that dominates discourse
on what data are and how they should be handled poses problems for
communicating what was actually encountered while excavating a feature,
including tentative thoughts, desires and apprehensions that are left
...
As such, this paper draws from a relatively small portion of the entire
set of observations and interviews, which largely pertain to fieldwork
...
expectations. See Batist (2024) and Batist (2025) for more in-depth
...
resolving this tension (cf. Batist 2025).
...
Here\paragraphnumber{[52]} is a list and brief description of
...
\textbf{Jane:}\paragraphnumber{[53]} Approaching another context, I
think.\\
...
\textbf{Jane:}\paragraphnumber{[54]} So, this is like still kind of a
...
\textbf{Zack:}\paragraphnumber{[55]} Did you feel like there are, like,
...
\textbf{Lester:}\paragraphnumber{[56]} And that was the time I really
...
Had\paragraphnumber{[57]} a brief convo with Olivia as she was cleaning
...
\textbf{Lester:}\paragraphnumber{[58]} So, our first week was tough.
...
\textbf{Ben:}\paragraphnumber{[59]} I think just sometimes, like, I've
...
\textbf{Zack:}\paragraphnumber{[60]} And uhh, the music is a thing, it
...
\textbf{Basil:}\paragraphnumber{[61]} I didn't have music in our
...
\textbf{Zack:}\paragraphnumber{[62]} So I have like one more section. We
...
\textbf{Zack:}\paragraphnumber{[63]} Okay. But with regards to
...
\textbf{Lauren:}\paragraphnumber{[64]} Exactly. Because I write it down.
...
\textbf{Zack:}\paragraphnumber{[65]} How does the feedback you get from
...
\textbf{Ben:}\paragraphnumber{[66]} I have interacted very little with
...
\textbf{Zack:}\paragraphnumber{[67]} What do you think of people like
...
\textbf{Zack:}\paragraphnumber{[68]} So umm, I guess I've already got
...
\textbf{Zack:}\paragraphnumber{[69]} So the third theme, and this is the
...
\textbf{Ben:}\paragraphnumber{[70]} Umm, I am not super academic. So
...
\textbf{Zack:}\paragraphnumber{[71]} Are you familiar with the work of
the ADS?\\
\textbf{Theo:} Yeah.\\
...
\textbf{Zack:}\paragraphnumber{[72]} So I'm not really, like I'm not
...
I\paragraphnumber{[73]} extend warm thanks to Costis Dallas, Matt Ratto,
...
Permits\paragraphnumber{[74]} were not required for this research.

\subsection{Funding}\label{funding}

This\paragraphnumber{[75]} work is derived from the author's doctoral
...
The\paragraphnumber{[76]} author states no conflicts of interest.

\subsection{Author Contribution}\label{author-contribution}

Zachary\paragraphnumber{[77]} Batist is the sole author of this work. He
...
Informed\paragraphnumber{[78]} consent has been obtained from all
...
The\paragraphnumber{[79]} data generated and analyzed during the current
study are included in this published article's supplementary files.

\subsection{Author Bio}\label{author-bio}

Zachary\paragraphnumber{[80]} Batist obtained his PhD from the
