...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, left=2mm, titlerule=0mm, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, breakable, toptitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, opacityback=0, colback=white]
