...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, rightrule=.15mm, coltitle=black, colback=white, breakable, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, titlerule=0mm, opacityback=0, bottomrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, left=2mm]
