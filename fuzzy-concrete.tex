...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, arc=.35mm, colback=white, breakable, colframe=quarto-callout-note-color-frame, titlerule=0mm, coltitle=black, bottomtitle=1mm, left=2mm, opacityback=0, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, rightrule=.15mm, toprule=.15mm, opacitybacktitle=0.6]
