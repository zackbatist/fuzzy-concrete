...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, left=2mm, toptitle=1mm, toprule=.15mm, bottomtitle=1mm, coltitle=black, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, arc=.35mm, opacityback=0, colback=white, colbacktitle=quarto-callout-note-color!10!white]
