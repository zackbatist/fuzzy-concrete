...
![Jane describes how she learned to recognize differences in the soil. Underlined text refer to especially significant eliciations elucidated above.](figures/training-eye.png){#fig-training-eye}
...
In other words, fieldworkers' efforts to shed their embodied experiences is a strategy for coping with an "epistemic anxiety", whereby archaeologists must grapple with a tension between the drive to produce confident records and their intuitive understanding that their own observations are inherently situated.
This is supported by systems that effectively re-assign creative agency from fieldworkers to data managers.
For instance, I previously noted that data managers, who are tasked with translating messy observations into concrete data structures, generally lack adequate understanding of the contexts in which data were initially recorded, and their coping strategies involve enforcing standards, workflows and rulesets among fieldworkers to obtain greater control over the data being sent to them, while emphasizing a need to channel information toward functional outcomes that are depdendent on formal/concrete/confident/highly-structured data [cf. @batist2024a].

It should also be emphasized that this is a systemic issues, and does not reflect individual archaeolgists' skills and abilities.
Moreover, there was remarkable consistency across archaeologists I spoke with on this matter, regardless of their degree of experience, and everyone I spoke with is both intuitively and explicitly aware of these concerns.
