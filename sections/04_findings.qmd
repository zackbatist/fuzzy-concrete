# Findings
I focus on a string of episodes during which Jane, a promising trench assistant working at an archaeological project, learned to identify, differentiate, and document parts of a stratigraphic sequence.
This illustrates how the constitution of the archaeological record and the internalization of archaeological knowledge occurred as part of project frameworks and collaborative relations that were structured by divisions of labor.
...
![Explanation of a potential context change using gestures and speech.](figures/context-change-annotated.png){#fig-context-change}
:::

:::: {#fig-context-change .content-visible when-format="html"}
::: {.panel-tabset .nav-pills}
### PNG
![](figures/context-change-annotated.png)

### GIF
![](figures/context-change-annotated.gif)
:::

Explanation of a potential context change using gestures and speech.
::::
...
:::{.content-visible when-format="pdf"}
![Discussion of a potential context change using gestures and speech.](figures/context-change-discussion.png){#fig-context-change-discussion}
:::

:::: {#fig-context-change-discussion .content-visible when-format="html"}
::: {.panel-tabset .nav-pills}
### PNG
![](figures/context-change-discussion.png)

### GIF
![](figures/context-change-discussion.gif)
:::

Discussion of a potential context change using gestures and speech.
::::
...
In some cases, fieldworkers found certain kinds of externally derived information useful as they excavated.
...
This may merely reflect the limited value proposition of making microscopic archaeobotanical visible to fieldworkers, in relation to the project's specific research objectives; it is actually quite feasible to provide fieldworkers with a basic magnifying loupe and instructing them on how to characterize pollen grains using a reference guide --- similar to how Jane learned to characterize soil samples.
However, this would require a more comprehensive partnership between specialists and fieldworkers, broadening the extreme focus that fieldworkers honed for themselves.
...
Rather than ingest loads of additional information, which involves learning how to make sense of it all and find it meaningful in a practical sense,^[A19](#sec-A19)^ the fieldworkers I spoke with went in the opposite direction; they value their extremely focused experiences with the material, which presents them with a unique and proprietary way of knowing that dissipates as they are, as @edgeworth2003 [: 115] put it, forced to "[detach themselves] from the task-in-hand to consider the material field from a distance".
...
All of what I described was in service of a broader systemic framework, which is informed by a (flawed) conception of the nature of archaeological data and of what constitutes proper or legitimate archaeological reasoning [@batist2025].
...
This is supported by systems that effectively re-assign creative agency from fieldworkers to data managers [@batist2024a; @batist2025].
...
At the same time, and in contrast with truly situated records like those maintained in field journals [cf. @batist2024a], the language documenting such tentativity in the report remained largely impersonal and observations were de-situated and disembodied.
