...
<!-- Including in contexts of reuse / frame reuse as something that happens both within and beyond a project's scope / make it about distance / Reference Faniel/Kansa here. -->
...
<!-- Make more explicit reference to this being a systemic issue. Make reference to @buccelatti2017, various works by Gavin Lucas, work by Colleen Morgan, Bill Caraher and Shawn Graham (which re-prioritize consideration of decisions and actions, including failure). -->
...
The fieldworkers I spoke with (including those whose elicitations do not appear in this paper; see @batist2023a, which is the broader dissertation from which this paper is derived) generally valued their contributions as sensory devices.
...
<!-- Make reference to data re-use, including @dallas2015 / @batist2024b approach that prioritizes reconcilation/anticipation and membership within a community of practice. -->
