...
> The informal learning experiences I was able to observe afforded me with such clearly articulated episodes like the ones I documented in this paper.
> There is in fact a strong precedent for documenting the norms, expectationa and values of community of practice through observations of contexts of teaching and learning, and there exists a strong tradition of this kind of work in archaeology specifically (see the work of Charles Goodwin, Joan Gero, Matt Edgeworth, Alison Mickel, Thomas Yarrow, among others).
> I revised the XX section to make the tenets and value of this approach more explicit.
>
> I added a supplement that describes the project from which these observations and interviews were drawn, including brief descriptions of the people mentioned throughout the paper --- though my ethics protocol limits how much I am able to expose.
> This is meant to help contextualize the work presented in the main paper.
> However, I have presented other very similar versions of this contextual information in other venues (in the dissertation, in Batist 2024, and in a paper currently under review by Peer Community in Archaeology), and I wonder if it would be better to simply make reference to the supplements attached to those other works rather than replicate it here; I will defer to the editor's judgement on how to proceed with this.
...
> The observations and elicitations I presented here illustrate a specific phenomenon with a more refined scope than than what is accounted for in the full dissertation.
...
> I clarified sectionn XX to more effectively communicate my position and the implications that this has on the study's findings.
