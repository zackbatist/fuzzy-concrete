...
Please note that I have consoliated my responses to some feedback provided by more than one reviewer for the sake of brevity.
...
I have made more detailed reference to the broader project from which this paper derives in section XX.
I decided to exclude a table accounting for all the data collected throughout the dissertation since my goal is to focus the readers' attantion on the refined scope of thos paper rather than extend it outward.
